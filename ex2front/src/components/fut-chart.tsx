  ...
  return (
    ...
    {/* Buttons container */}
            ...
            style={{
                border: '2px solid #ccc',  // Add border
                borderRadius: '10px',       // Optional: rounded corners
                padding: '20px',            // Padding for the new content
                height: '360px',            // Set height for the new section
            ...
            <p>GPUZ4</p>
            <p>EXPIRY:  18/12/2024 </p>
            <p>CONTRACT SPEC: Each contract is valued at $2500 times the contrade-grade Index.</p>
            <p> _</p>
            <p>SETTLEMENT PROCEDURE: Pegged to value of EX-H100 Index. Settles to the compounded daily EX-H100 Index rate during the 30 day reference period. This is a cash settled future where only PnL is transacted.</p>
